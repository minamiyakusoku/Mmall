...
public class CategoryManageController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "categoryName", value = "类别名称", required = true, dataType = "String",paramType="query"),
            @ApiImplicitParam(name = "parentId", value = "父级类别id", required = false, dataType = "int",paramType="query")})
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "categoryId", value = "类别ID（默认为查询全部一级类目）", required = false, dataType = "int",paramType="query")})
    ...
    @ApiOperation(value = "获取指定类目下的全部类目")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "categoryId", value = "类别ID（默认为查询全部一级类目）", required = false, dataType = "int",paramType="query")})
