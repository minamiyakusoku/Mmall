...
public class SmsUtil {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        String apikey = "75a22e0515585e084e8ec9c4a98c5fe0";

        //修改为您要发送的手机号
        String mobile = "15512180507";
        ...
        String tpl_value = URLEncoder.encode("#code#",ENCODING) +"="
                + URLEncoder.encode("minamikotori", ENCODING) + "&"
                + URLEncoder.encode("#app#",ENCODING) + "="
                + URLEncoder.encode("Akku未来电商",ENCODING);
        //模板发送的调用示例
